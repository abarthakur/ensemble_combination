...
np.random.shuffle(X)
pandas.DataFrame(X).to_csv("well_separated_linear.trn", header=None, index=False)
...
np.random.shuffle(X)
pandas.DataFrame(X).to_csv("well_separated_linear.tst", header=None, index=False)